...
public class SatsRestClient {
    ...
    private static final String CLASSTYPES_URL = "https://api2.sats.com/v1.0/se/classTypes";
    private static final String SATS_BASE_URL = "https://api2.sats.com/v1.0/se/";
    ...
    public static void get(String relativUrl, AsyncHttpResponseHandler responseHandler) {
        client.addHeader("Content-Type", "application/json");
        client.get(getAbsoluteUrl(relativUrl), responseHandler);
    }

//    public static void getClass(String centerId, AsyncHttpResponseHandler responseHandler){
//        client.addHeader("Content-Type", "application/json");
//        client.get(CENTER_URL+ centerId, responseHandler);
//    }

    private static String getAbsoluteUrl(String relativeUrl) {
        return SATS_BASE_URL + relativeUrl;
    }
